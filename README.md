...
* [Implemented a Word2Vec with the skip-gram model and CBOW model](https://github.com/ttungl/Deep-Learning-Google/blob/master/Lesson1/5_WordToVec.ipynb). (text8.zip) 
